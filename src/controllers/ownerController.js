...
export const vehicle_date=catchAsyncErrors(async(req,res,next)=>{
  let {carname,plateno,startdate,enddate}=req.body;
...
const vehicle=await Vehicle.findOne({vehiclePlateNumber:plateno})
...
plateno=vehicles[i].vehiclePlateNumber;
platenolist.push(plateno);
}
